...
const WhyChooseMobile = () => {
     const benefits = [
        ...
        { icon: <ShieldCheck size={32}/>, title: 'Scalable & Secure', description: 'We build robust apps designed to handle millions of users while ensuring scalable digital security.' },
