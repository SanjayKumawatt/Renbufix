                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <motion.p variants={itemVariants} className="mt-6 text-gray-600 text-lg leading-relaxed">
                            <strong>Renbufix Technologies</strong> is a rapidly evolving IT solutions partner headquartered in <strong>Faridabad, India</strong>. Born from a passion for innovation, we specialize in end-to-end software development, digital transformation, and strategic outsourcing.
                        </motion.p>
